/**
 * Warenkorb-Seite in v16 (App Router). Nutzt Tailwind-Klassen fuer das Layout.
 */
                ...
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        ...
                        <tr className="group">
                            ...
                            <td className="py-4 font-bold">1,99â‚¬</td>
                            <td className="py-4 text-right">
                                <button className="p-2 hover:bg-medium">1</button>
                            </td>
                            <td className="py-4 font-bold">3,50â‚¬</td>
                            <td className="py-4 text-right">
            ...
            <div className="lg:col-span-1">
                <div className="bg-white p-6 rounded-3xl shadow-xl border border-gray-100 sticky top-24">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <span className="text-2xl font-black text-primary">5,49â‚¬</span>
                    </div>
